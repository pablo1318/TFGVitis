...
reg   [31:0] out_stream_read_reg_100;
reg   [63:0] gmem0_addr_reg_105;
wire  signed [63:0] sext_ln116_fu_90_p1;
reg    ap_block_state1;
wire   [61:0] trunc_ln_fu_80_p4;
reg   [70:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state71) & (m_axi_gmem0_BVALID == 1'b1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (*) begin
    if (((ap_done_reg == 1'b1) | (ap_start == 1'b0) | (out_stream_empty_n == 1'b0) | (out_r_empty_n == 1'b0))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state71) & (m_axi_gmem0_BVALID == 1'b1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state3) & (m_axi_gmem0_WREADY == 1'b1))) begin
...
always @ (*) begin
    if ((~((ap_done_reg == 1'b1) | (ap_start == 1'b0) | (out_stream_empty_n == 1'b0) | (out_r_empty_n == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        out_r_read = 1'b1;
    end else begin
        out_r_read = 1'b0;
    end
...
always @ (*) begin
    ap_block_state1 = ((ap_done_reg == 1'b1) | (ap_start == 1'b0) | (out_stream_empty_n == 1'b0) | (out_r_empty_n == 1'b0));
end
...
assign ap_int_blocking_cur_n = out_r_blk_n;
...
assign m_axi_gmem0_AWADDR = gmem0_addr_reg_105;
...
assign m_axi_gmem0_WDATA = out_stream_read_reg_100;
...
assign sext_ln116_fu_90_p1 = $signed(trunc_ln_fu_80_p4);

assign trunc_ln_fu_80_p4 = {{out_r_dout[63:2]}};

endmodule //krnl_vadd_store_result
