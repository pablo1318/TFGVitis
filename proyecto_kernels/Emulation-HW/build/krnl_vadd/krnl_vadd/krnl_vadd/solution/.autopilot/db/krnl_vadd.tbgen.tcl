...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "7", "10", "11", "12", "13", "14", "15", "16"],
		"CDFG" : "krnl_vadd",
		"Protocol" : "ap_ctrl_chain",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "Dataflow", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "1",
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "4174", "EstimateLatencyMax" : "4174",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "1",
		...
		"Port" : [
			...
			{"Name" : "in1_stream", "Type" : "Fifo", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "load_input_U0", "Port" : "in1_stream"},
					{"ID" : "7", "SubInstance" : "compute_add_U0", "Port" : "in1_stream"}]},
			{"Name" : "out_stream", "Type" : "Fifo", "Direction" : "IO",
				"SubConnect" : [
					{"ID" : "10", "SubInstance" : "store_result_U0", "Port" : "out_stream"},
					{"ID" : "7", "SubInstance" : "compute_add_U0", "Port" : "out_stream"}]}]},
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.entry_proc_U0", "Parent" : "0",
		...
		"Port" : [
			{"Name" : "out_r", "Type" : "None", "Direction" : "I"},
			{"Name" : "out_r_c", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["10"], "DependentChan" : "11", "DependentChanDepth" : "4", "DependentChanType" : "2",
				"BlockSignal" : [
	...
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.load_input_U0", "Parent" : "0", "Child" : ["5"],
		...
		"Port" : [
			{"Name" : "gmem0", "Type" : "MAXI", "Direction" : "I",
				...
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "grp_load_input_Pipeline_mem_rd_fu_82", "Port" : "gmem0", "Inst_start_state" : "72", "Inst_end_state" : "73"}]},
			{"Name" : "in_r", "Type" : "None", "Direction" : "I"},
			{"Name" : "size", "Type" : "None", "Direction" : "I"},
			{"Name" : "size_c", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["7"], "DependentChan" : "12", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "size_c_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "in1_stream", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["7"], "DependentChan" : "13", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "5", "SubInstance" : "grp_load_input_Pipeline_mem_rd_fu_82", "Port" : "in1_stream", "Inst_start_state" : "72", "Inst_end_state" : "73"}]}]},
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.load_input_U0.grp_load_input_Pipeline_mem_rd_fu_82", "Parent" : "4", "Child" : ["6"],
		...
		"Port" : [
			...
			{"Name" : "size", "Type" : "None", "Direction" : "I"},
			{"Name" : "in1_stream", "Type" : "Fifo", "Direction" : "O",
				"BlockSignal" : [
	...
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.compute_add_U0", "Parent" : "0", "Child" : ["8"],
		"CDFG" : "compute_add",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			{"Name" : "size", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["4"], "DependentChan" : "12", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "size_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "in1_stream", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["4"], "DependentChan" : "13", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "8", "SubInstance" : "grp_compute_add_Pipeline_VITIS_LOOP_106_1_fu_53", "Port" : "in1_stream", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			{"Name" : "out_stream", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["10"], "DependentChan" : "14", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "out_stream_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "8", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.compute_add_U0.grp_compute_add_Pipeline_VITIS_LOOP_106_1_fu_53", "Parent" : "7", "Child" : ["9"],
		"CDFG" : "compute_add_Pipeline_VITIS_LOOP_106_1",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		"II" : "0",
	...
	{"ID" : "9", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.compute_add_U0.grp_compute_add_Pipeline_VITIS_LOOP_106_1_fu_53.flow_control_loop_pipe_sequential_init_U", "Parent" : "8"},
	{"ID" : "10", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.store_result_U0", "Parent" : "0",
		"CDFG" : "store_result",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "1", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			...
			{"Name" : "out_r", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["3"], "DependentChan" : "11", "DependentChanDepth" : "4", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "out_r_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "out_stream", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["7"], "DependentChan" : "14", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "out_stream_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "11", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.out_r_c_U", "Parent" : "0"},
	{"ID" : "12", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.size_c_U", "Parent" : "0"},
	{"ID" : "13", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.in1_stream_U", "Parent" : "0"},
	{"ID" : "14", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.out_stream_U", "Parent" : "0"},
	{"ID" : "15", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.start_for_store_result_U0_U", "Parent" : "0"},
...
set ArgLastReadFirstWriteLatency {
	krnl_vadd {
		...
		in1_stream {Type IO LastRead -1 FirstWrite -1}
	...
	load_input {
		...
		in1_stream {Type O LastRead -1 FirstWrite 2}}
	...
	compute_add {
		...
		out_stream {Type O LastRead -1 FirstWrite 3}}
	compute_add_Pipeline_VITIS_LOOP_106_1 {
		size_load {Type I LastRead 0 FirstWrite -1}
		accum_out {Type O LastRead -1 FirstWrite 1}
		in1_stream {Type I LastRead 1 FirstWrite -1}}
	store_result {
		gmem0 {Type O LastRead 3 FirstWrite 2}
		out_r {Type I LastRead 0 FirstWrite -1}
		out_stream {Type I LastRead 0 FirstWrite -1}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "4174", "Max" : "4174"}
	, {"Name" : "Interval", "Min" : "4172", "Max" : "4172"}
]}
