...
extern "C"
void krnl_vadd_hw_stub_wrapper(void*, void*, hls::sim::Byte<4>);

extern "C"
void apatb_krnl_vadd_hw(void* __xlx_apatb_param_in1, void* __xlx_apatb_param_out_r, hls::sim::Byte<4> __xlx_apatb_param_size)
{
  ...
  __xlx_offset_byte_param_out_r = 1*4;
  port3.param = { __xlx_apatb_param_in1, __xlx_apatb_param_out_r };
  port3.depth = { 1, 1 };
  port3.offset = { 0, 1 };
  ...
  try {
    ...
    krnl_vadd_hw_stub_wrapper(__xlx_apatb_param_in1, __xlx_apatb_param_out_r, __xlx_apatb_param_size);
