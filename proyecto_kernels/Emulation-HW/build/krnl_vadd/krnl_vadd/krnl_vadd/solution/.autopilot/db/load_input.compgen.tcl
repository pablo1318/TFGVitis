...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_size_c \
    op interface \
    ports { size_c_din { O 32 vector } size_c_num_data_valid { I 2 vector } size_c_fifo_cap { I 2 vector } size_c_full_n { I 1 bit } size_c_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { in1_stream_din { O 32 vector } in1_stream_num_data_valid { I 2 vector } in1_stream_fifo_cap { I 2 vector } in1_stream_full_n { I 1 bit } in1_stream_write { O 1 bit } } \
} "
}
