set moduleName load_input_Pipeline_mem_rd
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {load_input_Pipeline_mem_rd}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem0 int 32 regular {axi_master 0}  }
	{ sext_ln93 int 62 regular  }
	{ size int 32 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "in1","offset": { "type": "dynamic","port_name": "in1","bundle": "control"},"direction": "READONLY"},{"cName": "out_r","offset": { "type": "dynamic","port_name": "out_r","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "sext_ln93", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ in1_stream_din sc_out sc_lv 32 signal 3 } 
	{ in1_stream_num_data_valid sc_in sc_lv 2 signal 3 } 
	{ in1_stream_fifo_cap sc_in sc_lv 2 signal 3 } 
	{ in1_stream_full_n sc_in sc_logic 1 signal 3 } 
	{ in1_stream_write sc_out sc_logic 1 signal 3 } 
	{ sext_ln93 sc_in sc_lv 62 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln93", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln93", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln93 { ap_none {  { sext_ln93 in_data 0 62 } } }
