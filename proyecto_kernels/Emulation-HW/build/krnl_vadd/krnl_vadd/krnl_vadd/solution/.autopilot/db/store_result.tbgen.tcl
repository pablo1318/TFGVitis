...
set C_modelArgList {
	...
	{ out_stream int 32 regular {fifo 0 volatile } {global 0}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "in1","offset": { "type": "dynamic","port_name": "in1","bundle": "control"},"direction": "READONLY"},{"cName": "out_r","offset": { "type": "dynamic","port_name": "out_r","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "out_stream", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ out_stream_dout sc_in sc_lv 32 signal 2 } 
...
set Spec2ImplPortList { 
	...
	out_stream { ap_fifo {  { out_stream_dout fifo_port_we 0 32 }  { out_stream_num_data_valid fifo_status_num_data_valid 0 2 }  { out_stream_fifo_cap fifo_update 0 2 }  { out_stream_empty_n fifo_status 0 1 }  { out_stream_read fifo_data 1 1 } } }
}
