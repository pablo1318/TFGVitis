...
set C_modelArgList {
	...
	{ in1_stream int 32 regular {fifo 1 volatile } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "in1","offset": { "type": "dynamic","port_name": "in1","bundle": "control"},"direction": "READONLY"},{"cName": "out_r","offset": { "type": "dynamic","port_name": "out_r","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "in1_stream", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ size_c_din sc_out sc_lv 32 signal 3 } 
	{ size_c_num_data_valid sc_in sc_lv 2 signal 3 } 
	{ size_c_fifo_cap sc_in sc_lv 2 signal 3 } 
	{ size_c_full_n sc_in sc_logic 1 signal 3 } 
	{ size_c_write sc_out sc_logic 1 signal 3 } 
	{ in1_stream_din sc_out sc_lv 32 signal 4 } 
	{ in1_stream_num_data_valid sc_in sc_lv 2 signal 4 } 
	{ in1_stream_fifo_cap sc_in sc_lv 2 signal 4 } 
	{ in1_stream_full_n sc_in sc_logic 1 signal 4 } 
	{ in1_stream_write sc_out sc_logic 1 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "in1_stream_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "in1_stream", "role": "din" }} , 
 	...
 	{ "name": "in1_stream_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "in1_stream", "role": "full_n" }} , 
 	{ "name": "in1_stream_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "in1_stream", "role": "write" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"II" : "0",
		"VariableLatency" : "1", "ExactLatency" : "-1", "EstimateLatencyMin" : "1000075", "EstimateLatencyMax" : "1000075",
		"Combinational" : "0",
		"Datapath" : "0",
		"ClockEnable" : "0",
		"HasSubDataflow" : "0",
		...
		"Port" : [
			{"Name" : "gmem0", "Type" : "MAXI", "Direction" : "I",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_load_input_Pipeline_mem_rd_fu_82", "Port" : "gmem0", "Inst_start_state" : "72", "Inst_end_state" : "73"}]},
			...
			{"Name" : "in1_stream", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_load_input_Pipeline_mem_rd_fu_82", "Port" : "in1_stream", "Inst_start_state" : "72", "Inst_end_state" : "73"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_load_input_Pipeline_mem_rd_fu_82", "Parent" : "0", "Child" : ["2"],
	...
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_load_input_Pipeline_mem_rd_fu_82.flow_control_loop_pipe_sequential_init_U", "Parent" : "1"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1000075", "Max" : "1000075"}
	, {"Name" : "Interval", "Min" : "1000075", "Max" : "1000075"}
]}
...
set Spec2ImplPortList { 
	...
	in1_stream { ap_fifo {  { in1_stream_din fifo_port_we 1 32 }  { in1_stream_num_data_valid fifo_status_num_data_valid 0 2 }  { in1_stream_fifo_cap fifo_update 0 2 }  { in1_stream_full_n fifo_status 0 1 }  { in1_stream_write fifo_data 1 1 } } }
}
