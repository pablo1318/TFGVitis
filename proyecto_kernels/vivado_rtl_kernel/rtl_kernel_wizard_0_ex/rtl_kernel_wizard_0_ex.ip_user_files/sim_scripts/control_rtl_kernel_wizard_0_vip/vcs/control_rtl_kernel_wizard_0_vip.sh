...
#
# Generated by Vivado on Wed Mar 22 20:08:43 CET 2023
...
# executing this script. Please type 'control_rtl_kernel_wizard_0_vip.sh -help' for more information.
#
...
# Script info
echo -e "control_rtl_kernel_wizard_0_vip.sh - Script generated by export_simulation (Vivado v2022.2 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/../../../ipstatic/hdl" +incdir+"/media/pablo1318/hddLinux/XILINX/Vivado/2022.2/data/xilinx_vip/include" \
    "$ref_dir/../../../../rtl_kernel_wizard_0_ex.gen/sources_1/ip/control_rtl_kernel_wizard_0_vip/sim/control_rtl_kernel_wizard_0_vip_pkg.sv" \
  2>&1 | tee -a vlogan.log
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/../../../ipstatic/hdl" +incdir+"/media/pablo1318/hddLinux/XILINX/Vivado/2022.2/data/xilinx_vip/include" \
    "$ref_dir/../../../../rtl_kernel_wizard_0_ex.gen/sources_1/ip/control_rtl_kernel_wizard_0_vip/sim/control_rtl_kernel_wizard_0_vip.sv" \
  2>&1 | tee -a vlogan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.control_rtl_kernel_wizard_0_vip xil_defaultlib.glbl -o control_rtl_kernel_wizard_0_vip_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./control_rtl_kernel_wizard_0_vip_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key control_rtl_kernel_wizard_0_vip_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc control_rtl_kernel_wizard_0_vip_simv.daidir)
