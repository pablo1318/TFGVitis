...
always @(negedge dl_reset or posedge dl_clock) begin
    ...
    krnl_vadd_hls_deadlock_detect_unit #(4, 0, 2, 2) krnl_vadd_hls_deadlock_detect_unit_0 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_0_start_FIFO_blk[0] = 1'b0 | (~start_for_store_result_U0_U.if_full_n & entry_proc_U0.ap_start & ~entry_proc_U0.real_start & (trans_in_cnt_1 == trans_out_cnt_1) & ~start_for_store_result_U0_U.if_read);
    ...
    krnl_vadd_hls_deadlock_detect_unit #(4, 1, 2, 2) krnl_vadd_hls_deadlock_detect_unit_1 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_1_data_FIFO_blk[0] = 1'b0 | (~load_input_U0.size_c_blk_n) | (~load_input_U0.grp_load_input_Pipeline_mem_rd_fu_82.in1_stream_blk_n);
    assign proc_1_data_PIPO_blk[0] = 1'b0;
    assign proc_1_start_FIFO_blk[0] = 1'b0 | (~start_for_compute_add_U0_U.if_full_n & load_input_U0.ap_start & ~load_input_U0.real_start & (trans_in_cnt_0 == trans_out_cnt_0) & ~start_for_compute_add_U0_U.if_read);
    ...
    // Process: compute_add_U0
    krnl_vadd_hls_deadlock_detect_unit #(4, 2, 2, 2) krnl_vadd_hls_deadlock_detect_unit_2 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_2_data_FIFO_blk[0] = 1'b0 | (~compute_add_U0.size_blk_n) | (~compute_add_U0.grp_compute_add_Pipeline_VITIS_LOOP_106_1_fu_53.in1_stream_blk_n);
    assign proc_2_data_PIPO_blk[0] = 1'b0;
    assign proc_2_start_FIFO_blk[0] = 1'b0 | (~start_for_compute_add_U0_U.if_empty_n & compute_add_U0.ap_idle & ~start_for_compute_add_U0_U.if_write);
    assign proc_2_TLF_FIFO_blk[0] = 1'b0;
    assign proc_2_input_sync_blk[0] = 1'b0;
    assign proc_2_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_2[0] = dl_detect_out ? proc_dep_vld_vec_2_reg[0] : (proc_2_data_FIFO_blk[0] | proc_2_data_PIPO_blk[0] | proc_2_start_FIFO_blk[0] | proc_2_TLF_FIFO_blk[0] | proc_2_input_sync_blk[0] | proc_2_output_sync_blk[0]);
    assign proc_2_data_FIFO_blk[1] = 1'b0 | (~compute_add_U0.out_stream_blk_n);
    ...
    // Process: store_result_U0
    krnl_vadd_hls_deadlock_detect_unit #(4, 3, 2, 2) krnl_vadd_hls_deadlock_detect_unit_3 (
        .reset(dl_reset),
        .clock(dl_clock),
    ...
    assign proc_3_data_FIFO_blk[0] = 1'b0 | (~store_result_U0.out_r_blk_n);
    assign proc_3_data_PIPO_blk[0] = 1'b0;
    assign proc_3_start_FIFO_blk[0] = 1'b0 | (~start_for_store_result_U0_U.if_empty_n & store_result_U0.ap_idle & ~start_for_store_result_U0_U.if_write);
    assign proc_3_TLF_FIFO_blk[0] = 1'b0;
    assign proc_3_input_sync_blk[0] = 1'b0;
    assign proc_3_output_sync_blk[0] = 1'b0;
    assign proc_dep_vld_vec_3[0] = dl_detect_out ? proc_dep_vld_vec_3_reg[0] : (proc_3_data_FIFO_blk[0] | proc_3_data_PIPO_blk[0] | proc_3_start_FIFO_blk[0] | proc_3_TLF_FIFO_blk[0] | proc_3_input_sync_blk[0] | proc_3_output_sync_blk[0]);
    assign proc_3_data_FIFO_blk[1] = 1'b0 | (~store_result_U0.out_stream_blk_n);
...
`include "krnl_vadd_hls_deadlock_report_unit.vh"
