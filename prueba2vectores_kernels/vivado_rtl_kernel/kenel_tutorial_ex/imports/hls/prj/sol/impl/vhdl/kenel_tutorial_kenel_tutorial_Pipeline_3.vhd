...
entity kenel_tutorial_kenel_tutorial_Pipeline_3 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of kenel_tutorial_kenel_tutorial_Pipeline_3 is 
...
attribute shreg_extract : string;
    ...
    signal empty_23_reg_225 : STD_LOGIC_VECTOR (0 downto 0);
    signal empty_23_reg_225_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal empty_23_fu_137_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal empty_21_fu_184_p3 : STD_LOGIC_VECTOR (479 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal loop_index_fu_68 : STD_LOGIC_VECTOR (12 downto 0);
    signal empty_20_fu_122_p2 : STD_LOGIC_VECTOR (12 downto 0);
    signal ap_sig_allocacmp_loop_index_load : STD_LOGIC_VECTOR (12 downto 0);
    signal empty_22_fu_133_p1 : STD_LOGIC_VECTOR (3 downto 0);
    ...
    component kenel_tutorial_flow_control_loop_pipe_sequential_init IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    flow_control_loop_pipe_sequential_init_U : component kenel_tutorial_flow_control_loop_pipe_sequential_init
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => ap_start,
    ...
    ap_block_state3_io_assign_proc : process(m_axi_m00_axi_WREADY, empty_23_reg_225_pp0_iter1_reg)
    begin
                ap_block_state3_io <= ((empty_23_reg_225_pp0_iter1_reg = ap_const_lv1_1) and (m_axi_m00_axi_WREADY = ap_const_logic_0));
    end process;
    ...
    empty_20_fu_122_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_loop_index_load) + unsigned(ap_const_lv13_1));
    empty_21_fu_184_p3 <= 
        ap_const_lv480_lc_1 when (empty_23_reg_225_pp0_iter1_reg(0) = '1') else 
        tmp_2_fu_177_p3;
    empty_22_fu_133_p1 <= ap_sig_allocacmp_loop_index_load(4 - 1 downto 0);
    empty_23_fu_137_p2 <= "1" when (empty_22_fu_133_p1 = ap_const_lv4_F) else "0";
    ...
    m00_axi_blk_n_W_assign_proc : process(ap_enable_reg_pp0_iter2, m_axi_m00_axi_WREADY, empty_23_reg_225_pp0_iter1_reg, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (empty_23_reg_225_pp0_iter1_reg = ap_const_lv1_1) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
    ...
    m_axi_m00_axi_WVALID_assign_proc : process(ap_enable_reg_pp0_iter2, empty_23_reg_225_pp0_iter1_reg, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (empty_23_reg_225_pp0_iter1_reg = ap_const_lv1_1) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
