...
extern "C"
void rtl_kernel_wizard_0_hw_stub_wrapper(hls::sim::Byte<4>, void*);

extern "C"
void apatb_rtl_kernel_wizard_0_hw(hls::sim::Byte<4> __xlx_apatb_param_scalar00, void* __xlx_apatb_param_axi00_ptr0)
{
  ...
  port1.param = &__xlx_offset_byte_param_axi00_ptr0;
  ...
  port2.param = { __xlx_apatb_param_axi00_ptr0 };
  port2.depth = { 1 };
  port2.offset = {  };
  port2.hasWrite = { true };
