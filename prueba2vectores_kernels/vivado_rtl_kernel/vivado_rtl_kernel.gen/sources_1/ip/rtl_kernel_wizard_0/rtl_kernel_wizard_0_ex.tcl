#-------------------------------------------------------------
# Generated Example Tcl script for IP 'rtl_kernel_wizard_0' (xilinx.com:ip:rtl_kernel_wizard:1.0)
#-------------------------------------------------------------
...
set srcIpDir "/home/pablo1318/workspace/prueba2vectores_kernels/vivado_rtl_kernel/vivado_rtl_kernel.gen/sources_1/ip/rtl_kernel_wizard_0"

# Declare xci file location
set srcXciDir "/home/pablo1318/workspace/prueba2vectores_kernels/vivado_rtl_kernel/vivado_rtl_kernel.srcs/sources_1/ip/rtl_kernel_wizard_0"

# Create project
puts "INFO: \[open_example_project\] Creating new example project..."
create_project -name rtl_kernel_wizard_0_ex -force -rtl_kernel
...
import_ip -files [list [file join $srcIpDir ../../../../vivado_rtl_kernel.srcs/sources_1/ip/rtl_kernel_wizard_0/rtl_kernel_wizard_0.xci]] -name rtl_kernel_wizard_0
if { $returnCode == 0 } { 
  reset_target {open_example} [get_ips rtl_kernel_wizard_0]
  ...
  generate_target [_filter_supported_targets {instantiation_template synthesis simulation implementation shared_logic} [get_ips rtl_kernel_wizard_0]] [get_ips rtl_kernel_wizard_0]
} 
...
if { $returnCode == 0 } { 
  ...
  [list [file join $srcIpDir foo/rtl_kernel_wizard_0.v]] \
  [list [file join $srcIpDir rtl_kernel_wizard_0_example_adder.v]] \
  [list [file join $srcIpDir rtl_kernel_wizard_0_example_axi_read_master.sv]] \
  [list [file join $srcIpDir rtl_kernel_wizard_0_example_axi_write_master.sv]] \
  [list [file join $srcIpDir rtl_kernel_wizard_0_example_counter.sv]] \
  [list [file join $srcIpDir rtl_kernel_wizard_0_example_vadd.sv]] \
  [list [file join $srcIpDir rtl_kernel_wizard_0_example.sv]]
set_property FILE_TYPE SystemVerilog [get_files [list [file join $importDir rtl_kernel_wizard_0_example_axi_read_master.sv]]]
set_property FILE_TYPE SystemVerilog [get_files [list [file join $importDir rtl_kernel_wizard_0_example_axi_write_master.sv]]]
set_property FILE_TYPE SystemVerilog [get_files [list [file join $importDir rtl_kernel_wizard_0_example_counter.sv]]]
set_property FILE_TYPE SystemVerilog [get_files [list [file join $importDir rtl_kernel_wizard_0_example_vadd.sv]]]
set_property FILE_TYPE SystemVerilog [get_files [list [file join $importDir rtl_kernel_wizard_0_example.sv]]]
} 
...
if { $returnCode == 0 } { 
  ...
  [list [file join $srcIpDir rtl_kernel_wizard_0_cpp]]
} 
...
if { $returnCode == 0 } { 
  ...
  [list [file join $srcIpDir rtl_kernel_wizard_0_ooc.xdc]] \
  [list [file join $srcIpDir rtl_kernel_wizard_0_user.xdc]]
...
if { $returnCode == 0 } { 
  ...
  [list [file join $srcIpDir rtl_kernel_wizard_0_tb.sv]]
set_property FILE_TYPE SystemVerilog [get_files [list [file join $importDir rtl_kernel_wizard_0_tb.sv]]]
set_property USED_IN_SYNTHESIS false [get_files [list [file join $importDir rtl_kernel_wizard_0_tb.sv]]]
} 
