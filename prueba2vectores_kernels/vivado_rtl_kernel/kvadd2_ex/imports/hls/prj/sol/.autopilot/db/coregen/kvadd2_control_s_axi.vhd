...
entity kvadd2_control_s_axi is
generic (
...
end entity kvadd2_control_s_axi;
...
architecture behave of kvadd2_control_s_axi is
    ...
    constant ADDR_RES_DATA_0 : INTEGER := 16#28#;
    constant ADDR_RES_DATA_1 : INTEGER := 16#2c#;
    constant ADDR_RES_CTRL   : INTEGER := 16#30#;
