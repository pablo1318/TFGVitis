...
# 2 "<built-in>" 2
# 1 "../kvadd2_cmodel.cpp" 2
# 17 "../kvadd2_cmodel.cpp"
...
# 21 "../kvadd2_cmodel.cpp" 2





extern "C" __attribute__((sdx_kernel("kvadd2", 0))) void kvadd2 (
    int* A,
    int* B,
    int* res
) {
#line 9 "/home/pablo1318/workspace/prueba2vectores_kernels/vivado_rtl_kernel/kvadd2_ex/imports/hls/run_hls.tcl"
#pragma HLSDIRECTIVE TOP name=kvadd2
# 30 "../kvadd2_cmodel.cpp"
...
#pragma HLS INTERFACE ap_ctrl_hs port=return
 ...
 int m00_axi_input_buffer[8192];
    ...
    VITIS_LOOP_56_1: for (unsigned int i = 0; i < m00_axi_length; i++) {
    ...
    VITIS_LOOP_77_2: for (unsigned int i = 0; i < m01_axi_length; i++) {
    ...
    VITIS_LOOP_98_3: for (unsigned int i = 0; i < m02_axi_length; i++) {
