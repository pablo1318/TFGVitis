...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto  -L axi_infrastructure_v1_1_0 -L xil_defaultlib -L axi_vip_v1_1_13 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot slv_m00_axi_vip xil_defaultlib.slv_m00_axi_vip xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim -sv_seed 1 slv_m00_axi_vip -key {Behavioral:sim_1:Functional:slv_m00_axi_vip} -tclbatch cmd.tcl -log simulate.log
}
