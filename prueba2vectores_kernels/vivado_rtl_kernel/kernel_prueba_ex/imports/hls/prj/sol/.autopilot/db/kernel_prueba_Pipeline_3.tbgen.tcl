set moduleName kernel_prueba_Pipeline_3
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {kernel_prueba_Pipeline_3}
set C_modelType { void 0 }
set C_modelArgList {
	{ m00_axi int 512 regular {axi_master 1}  }
	{ sext_ln51 int 58 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "m00_axi", "interface" : "axi_master", "bitwidth" : 512, "direction" : "WRITEONLY", "bitSlice":[ {"cElement": [{"cName": "axi00_ptr0","offset": { "type": "dynamic","port_name": "axi00_ptr0","bundle": "control"},"direction": "READWRITE"}]}]} , 
 	{ "Name" : "sext_ln51", "interface" : "wire", "bitwidth" : 58, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln51 sc_in sc_lv 58 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln51", "direction": "in", "datatype": "sc_lv", "bitwidth":58, "type": "signal", "bundle":{"name": "sext_ln51", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	sext_ln51 { ap_none {  { sext_ln51 in_data 0 58 } } }
