...
# 2 "<built-in>" 2
# 1 "../kernel_prueba_cmodel.cpp" 2
# 17 "../kernel_prueba_cmodel.cpp"
...
# 21 "../kernel_prueba_cmodel.cpp" 2





extern "C" __attribute__((sdx_kernel("kernel_prueba", 0))) void kernel_prueba (
    int in1,
    int in2,
    int* axi00_ptr0
) {
#line 9 "/home/pablo1318/workspace/prueba2vectores_kernels/vivado_rtl_kernel/kernel_prueba_ex/imports/hls/run_hls.tcl"
#pragma HLSDIRECTIVE TOP name=kernel_prueba
# 30 "../kernel_prueba_cmodel.cpp"
...
#pragma HLS INTERFACE ap_ctrl_hs port=return
 ...
 int m00_axi_input_buffer[8192];
    ...
    VITIS_LOOP_54_1: for (unsigned int i = 0; i < m00_axi_length; i++) {
