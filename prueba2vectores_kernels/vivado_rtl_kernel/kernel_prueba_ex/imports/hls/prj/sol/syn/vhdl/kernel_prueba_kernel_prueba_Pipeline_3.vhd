...
entity kernel_prueba_kernel_prueba_Pipeline_3 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    sext_ln51 : IN STD_LOGIC_VECTOR (57 downto 0);
...
architecture behav of kernel_prueba_kernel_prueba_Pipeline_3 is 
...
attribute shreg_extract : string;
    ...
    signal empty_26_reg_225 : STD_LOGIC_VECTOR (0 downto 0);
    signal empty_26_reg_225_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal ap_block_state3_io : BOOLEAN;
    signal ap_block_pp0_stage0_subdone : BOOLEAN;
    signal exitcond3_fu_116_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal exitcond3_reg_216 : STD_LOGIC_VECTOR (0 downto 0);
    signal empty_26_fu_137_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal m00_axi_output_buffer_load_reg_235 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_condition_exit_pp0_iter1_stage0 : STD_LOGIC;
    signal loop_index_cast3_fu_128_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal shiftreg_fu_64 : STD_LOGIC_VECTOR (479 downto 0);
    signal empty_24_fu_184_p3 : STD_LOGIC_VECTOR (479 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal loop_index_fu_68 : STD_LOGIC_VECTOR (12 downto 0);
    signal empty_23_fu_122_p2 : STD_LOGIC_VECTOR (12 downto 0);
    signal ap_sig_allocacmp_loop_index_load : STD_LOGIC_VECTOR (12 downto 0);
    signal empty_25_fu_133_p1 : STD_LOGIC_VECTOR (3 downto 0);
    signal tmp_1_fu_167_p4 : STD_LOGIC_VECTOR (447 downto 0);
    signal tmp_2_fu_177_p3 : STD_LOGIC_VECTOR (479 downto 0);
    ...
    component kernel_prueba_flow_control_loop_pipe_sequential_init IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    flow_control_loop_pipe_sequential_init_U : component kernel_prueba_flow_control_loop_pipe_sequential_init
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => ap_start,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (exitcond3_fu_116_p2 = ap_const_lv1_0))) then 
                    loop_index_fu_68 <= empty_23_fu_122_p2;
        ...
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
                    ...
                    shiftreg_fu_64 <= empty_24_fu_184_p3;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                ...
                empty_26_reg_225_pp0_iter1_reg <= empty_26_reg_225;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (exitcond3_fu_116_p2 = ap_const_lv1_0))) then
                empty_26_reg_225 <= empty_26_fu_137_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (exitcond3_reg_216 = ap_const_lv1_0))) then
    ...
    ap_block_state3_io_assign_proc : process(m_axi_m00_axi_WREADY, empty_26_reg_225_pp0_iter1_reg)
    begin
                ap_block_state3_io <= ((empty_26_reg_225_pp0_iter1_reg = ap_const_lv1_1) and (m_axi_m00_axi_WREADY = ap_const_logic_0));
    end process;

        ap_block_state3_pp0_stage0_iter2 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, exitcond3_fu_116_p2)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (exitcond3_fu_116_p2 = ap_const_lv1_1))) then 
    ...
    ap_condition_exit_pp0_iter1_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_subdone, exitcond3_reg_216)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (exitcond3_reg_216 = ap_const_lv1_1))) then 
    ...
    empty_23_fu_122_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_loop_index_load) + unsigned(ap_const_lv13_1));
    empty_24_fu_184_p3 <= 
        ap_const_lv480_lc_1 when (empty_26_reg_225_pp0_iter1_reg(0) = '1') else 
        tmp_2_fu_177_p3;
    empty_25_fu_133_p1 <= ap_sig_allocacmp_loop_index_load(4 - 1 downto 0);
    empty_26_fu_137_p2 <= "1" when (empty_25_fu_133_p1 = ap_const_lv4_F) else "0";
    exitcond3_fu_116_p2 <= "1" when (ap_sig_allocacmp_loop_index_load = ap_const_lv13_1000) else "0";
    loop_index_cast3_fu_128_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_loop_index_load),64));

    m00_axi_blk_n_W_assign_proc : process(ap_enable_reg_pp0_iter2, m_axi_m00_axi_WREADY, empty_26_reg_225_pp0_iter1_reg, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (empty_26_reg_225_pp0_iter1_reg = ap_const_lv1_1) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
    ...
    m00_axi_output_buffer_address0 <= loop_index_cast3_fu_128_p1(13 - 1 downto 0);
    ...
    m_axi_m00_axi_WDATA <= (m00_axi_output_buffer_load_reg_235 & shiftreg_fu_64);
    ...
    m_axi_m00_axi_WVALID_assign_proc : process(ap_enable_reg_pp0_iter2, empty_26_reg_225_pp0_iter1_reg, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (empty_26_reg_225_pp0_iter1_reg = ap_const_lv1_1) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
    ...
    tmp_1_fu_167_p4 <= shiftreg_fu_64(479 downto 32);
    tmp_2_fu_177_p3 <= (m00_axi_output_buffer_load_reg_235 & tmp_1_fu_167_p4);
end behav;
