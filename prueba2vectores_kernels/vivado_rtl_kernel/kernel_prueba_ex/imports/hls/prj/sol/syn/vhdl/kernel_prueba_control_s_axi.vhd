...
entity kernel_prueba_control_s_axi is
generic (
...
end entity kernel_prueba_control_s_axi;
...
architecture behave of kernel_prueba_control_s_axi is
    ...
    constant ADDR_AXI00_PTR0_DATA_0 : INTEGER := 16#20#;
    constant ADDR_AXI00_PTR0_DATA_1 : INTEGER := 16#24#;
    constant ADDR_AXI00_PTR0_CTRL   : INTEGER := 16#28#;
