...
# 21 "../kvadd_cmodel.cpp" 2





extern "C" __attribute__((sdx_kernel("kvadd", 0))) void kvadd (
    int* A,
    int* B,
    int* res
) {
#line 9 "/home/pablo1318/workspace/prueba2vectores_kernels/vivado_rtl_kernel/kvadd_ex/imports/hls/run_hls.tcl"
#pragma HLSDIRECTIVE TOP name=kvadd
# 30 "../kvadd_cmodel.cpp"
