; ModuleID = '/home/pablo1318/workspace/prueba2vectores_kernels/vivado_rtl_kernel/kvadd_tutorial_ex/imports/hls/prj/sol/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: inaccessiblemem_or_argmemonly noinline
define void @apatb_kvadd_tutorial_ir(i32 %scalar00, i32* noalias nocapture nonnull %A, i32* noalias nocapture nonnull %B, i32* noalias nocapture nonnull %res) local_unnamed_addr #0 {
entry:
  %A_copy = alloca i32, align 512
  %B_copy = alloca i32, align 512
  %res_copy = alloca i32, align 512
  call fastcc void @copy_in(i32* nonnull %A, i32* nonnull align 512 %A_copy, i32* nonnull %B, i32* nonnull align 512 %B_copy, i32* nonnull %res, i32* nonnull align 512 %res_copy)
  call void @apatb_kvadd_tutorial_hw(i32 %scalar00, i32* %A_copy, i32* %B_copy, i32* %res_copy)
  call void @copy_back(i32* %A, i32* %A_copy, i32* %B, i32* %B_copy, i32* %res, i32* %res_copy)
  ret void
}
...
declare void @apatb_kvadd_tutorial_hw(i32, i32*, i32*, i32*)
...
define void @kvadd_tutorial_hw_stub_wrapper(i32, i32*, i32*, i32*) #4 {
entry:
  call void @copy_out(i32* null, i32* %1, i32* null, i32* %2, i32* null, i32* %3)
  call void @kvadd_tutorial_hw_stub(i32 %0, i32* %1, i32* %2, i32* %3)
  call void @copy_in(i32* null, i32* %1, i32* null, i32* %2, i32* null, i32* %3)
  ret void
}

declare void @kvadd_tutorial_hw_stub(i32, i32*, i32*, i32*)
