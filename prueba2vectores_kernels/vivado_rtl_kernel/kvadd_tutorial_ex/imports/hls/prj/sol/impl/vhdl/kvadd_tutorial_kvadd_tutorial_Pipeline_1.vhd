...
entity kvadd_tutorial_kvadd_tutorial_Pipeline_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    sext_ln55 : IN STD_LOGIC_VECTOR (57 downto 0);
...
architecture behav of kvadd_tutorial_kvadd_tutorial_Pipeline_1 is 
...
attribute shreg_extract : string;
    ...
    signal empty_54_reg_209 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal empty_54_fu_132_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal empty_54_reg_209_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal m00_axi_addr_read_reg_213 : STD_LOGIC_VECTOR (511 downto 0);
    signal ap_condition_exit_pp0_iter1_stage0 : STD_LOGIC;
    signal ap_phi_mux_empty_51_phi_fu_93_p4 : STD_LOGIC_VECTOR (511 downto 0);
    signal ap_phi_reg_pp0_iter2_empty_51_reg_90 : STD_LOGIC_VECTOR (511 downto 0);
    ...
    signal empty_50_fu_122_p2 : STD_LOGIC_VECTOR (12 downto 0);
    signal ap_sig_allocacmp_loop_index15_load : STD_LOGIC_VECTOR (12 downto 0);
    signal empty_53_fu_128_p1 : STD_LOGIC_VECTOR (3 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_boolean_0 = ap_block_pp0_stage0_11001)) then
                if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_loop_init = ap_const_logic_1))) then 
                    ...
                    shiftreg43_fu_58 <= ap_phi_mux_empty_51_phi_fu_93_p4(511 downto 32);
                end if;
            end if; 
        end if;
    end process;
    ...
    ap_phi_mux_empty_51_phi_fu_93_p4_assign_proc : process(exitcond3017_reg_205_pp0_iter1_reg, empty_54_reg_209_pp0_iter1_reg, m00_axi_addr_read_reg_213, ap_phi_reg_pp0_iter2_empty_51_reg_90, shiftreg43_cast_fu_152_p1)
    begin
        if ((exitcond3017_reg_205_pp0_iter1_reg = ap_const_lv1_0)) then
            if ((empty_54_reg_209_pp0_iter1_reg = ap_const_lv1_0)) then 
                ap_phi_mux_empty_51_phi_fu_93_p4 <= shiftreg43_cast_fu_152_p1;
            elsif ((empty_54_reg_209_pp0_iter1_reg = ap_const_lv1_1)) then 
    ...
    ap_phi_reg_pp0_iter2_empty_51_reg_90 <= "";

    ap_predicate_op25_read_state2_assign_proc : process(exitcond3017_reg_205, empty_54_reg_209)
    begin
                ap_predicate_op25_read_state2 <= ((empty_54_reg_209 = ap_const_lv1_1) and (exitcond3017_reg_205 = ap_const_lv1_0));
    end process;
    ...
    empty_50_fu_122_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_loop_index15_load) + unsigned(ap_const_lv13_1));
    empty_53_fu_128_p1 <= ap_sig_allocacmp_loop_index15_load(4 - 1 downto 0);
    empty_54_fu_132_p2 <= "1" when (empty_53_fu_128_p1 = ap_const_lv4_0) else "0";
    ...
    m00_axi_input_buffer_d0 <= ap_phi_mux_empty_51_phi_fu_93_p4(32 - 1 downto 0);
