...
#
# Generated by Vivado on Thu Apr 20 18:30:08 CEST 2023
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/../../../ipstatic/hdl" +incdir+"/media/pablo1318/hddLinux/XILINX/Vivado/2022.2/data/xilinx_vip/include" \
    "$ref_dir/../../../../kvadd_tutorial_ex.gen/sources_1/ip/slv_m00_axi_vip/sim/slv_m00_axi_vip_pkg.sv" \
  2>&1 | tee -a vlogan.log
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/../../../ipstatic/hdl" +incdir+"/media/pablo1318/hddLinux/XILINX/Vivado/2022.2/data/xilinx_vip/include" \
    "$ref_dir/../../../../kvadd_tutorial_ex.gen/sources_1/ip/slv_m00_axi_vip/sim/slv_m00_axi_vip.sv" \
  2>&1 | tee -a vlogan.log
