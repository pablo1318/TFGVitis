...
module probatina_probatina_Pipeline_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
probatina_flow_control_loop_pipe_sequential_init flow_control_loop_pipe_sequential_init_U(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .ap_start(ap_start),
    .ap_ready(ap_ready),
...
endmodule //probatina_probatina_Pipeline_1
